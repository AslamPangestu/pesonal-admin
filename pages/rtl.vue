...
const BIG_CHART_DATA = [
  [100, 70, 90, 70, 85, 60, 75, 60, 90, 80, 110, 100],
  [80, 120, 105, 110, 95, 105, 90, 100, 80, 95, 70, 120],
  [60, 80, 65, 130, 80, 105, 90, 130, 70, 115, 60, 130],
]
const BIG_CHART_LABEL = [
  'JAN',
  'FEB',
  'MAR',
  'APR',
...
const BIG_CHART_DATASET_OPTIONS = {
  fill: true,
    ...
    return {
      ...
      bigLineChart: {
        ...
        chartData: {
          datasets: [
            {
              ...BIG_CHART_DATASET_OPTIONS,
              data: BIG_CHART_DATA[0],
            },
          ],
          labels: BIG_CHART_LABEL,
        },
